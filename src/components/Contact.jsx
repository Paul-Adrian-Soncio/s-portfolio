...
const Contact = () => {
  ...
  <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white z-10">
    ...
    <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center items-center">
            <form action="https://getform.io/f/21a89d1d-b9d7-4159-a19d-1c61b09503e4" method="POST"
